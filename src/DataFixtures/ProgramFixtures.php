...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $program->setYear(2018);
        $program->setCountry('Georgies');
        $manager->persist($program);
        $this->addReference('PROGRAM_THE_HAUNTING_HOUSE', $program);
        ...
        $program->setCountry('United States');
        $manager->persist($program);
        $this->addReference('PROGRAM_AMERICAN_HORROR_STORY', $program);
        ...
        $program->setCountry('Texas');
        $manager->persist($program);
        $this->addReference('PROGRAM_LOVE_DEATH_ROBOTS', $program);
        ...
        $program->setCountry('Virginie');
        $manager->persist($program);
        $this->addReference('PROGRAM_PENNY_DREADFUL', $program);
        ...
        $program->setCountry('Missouri');
        $manager->persist($program);
        $this->addReference('PROGRAM_FEAR_WALKING_DEAD', $program);
